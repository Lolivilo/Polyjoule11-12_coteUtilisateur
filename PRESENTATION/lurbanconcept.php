<?php
	...
	$currentCat = getCategorieById($_GET['cat']);	// Categorie actuelle => Urban concept
?>
...
<body>
	...
	?>
	<div id='corps'>
		<h2 id='titreArticle'><img src="Style/image/banniere_urbanConcept.png" alt="Image de l'UrbanConcept"/></h2>
